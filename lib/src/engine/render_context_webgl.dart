...
class RenderContextWebGL extends RenderContext {
  ...
  final RenderBufferIndex renderBufferIndexQuads = new RenderBufferIndex.forQuads(8192);
  final RenderBufferIndex renderBufferIndexTriangles = new RenderBufferIndex.forTriangles(8192);
